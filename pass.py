...
def ListOfImportantWords():
    ...
    names.append(input("National Code:"))
    print("\n")
    ...
    names.append(input("spouse name"))
    print("\n")
    names.append(input("City:"))
    names.append(input("Country:"))
    names.append(input("Favourite colour:"))
    names.append(input("favourite car:"))
    names.append(input("favourite girl:"))
    names.append(input("favourite country:"))
    names.append(input("favourite city:"))
